...
function getAddition(number, target)
  local offset = number - target
  return "tonumber(\""..offset.."\")+"
end

-- print(getAddition(5, 4))

local function mutateNumber(number) -- should encode 3 as like #"255" to really fuck with people
    if #number == 0 then return number end
    -- char < or equal to, byte, etc.,
    -- concat
    -- print("Num:" .. number)
