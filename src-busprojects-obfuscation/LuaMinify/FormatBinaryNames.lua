...
local function Format_Mini(ast)
	...
	formatExpr = function(expr)
		...
		elseif expr.AstType == 'DotsExpr' then -- INTEREST
			out = out.."..."
		...
		elseif expr.AstType == 'TableCallExpr' then -- INTEREST
			out = out..formatExpr(expr.Base)
			out = out..formatExpr(expr.Arguments[1])

		elseif expr.AstType == 'StringCallExpr' then -- INTEREST
			out = out..formatExpr(expr.Base)
		...
		elseif expr.AstType == 'Function' then
			expr.Scope:ObfuscateVariables("binary")
			out = out.."function("
		...
		elseif expr.AstType == 'ConstructorExpr' then -- can i generate junk arguments?
			out = out.."{"
	...
	local formatStatement = function(statement)
		...
		elseif statement.AstType == 'Function' then
			statement.Scope:ObfuscateVariables"binary"
	...
	formatStatlist = function(statList)
		local out = ''
		statList.Scope:ObfuscateVariables"binary"
	...
	ast.Scope:ObfuscateVariables"binary"
